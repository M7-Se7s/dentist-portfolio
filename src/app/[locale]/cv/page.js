...
export default async function CVPage({ params }) {
  ...
  const nameToUse =
    isAr && basicInfoAr?.name ? basicInfoAr.name : basicInfo.name;
  const titleToUse =
    isAr && basicInfoAr?.title ? basicInfoAr.title : basicInfo.title;
  const locationToUse =
    isAr && basicInfoAr?.location ? basicInfoAr.location : basicInfo.location;
  const summaryToUse = isAr && summaryAr ? summaryAr : summary;
  const coreCompetenciesToUse =
    isAr && coreCompetenciesAr?.length ? coreCompetenciesAr : coreCompetencies;
  const licensureToUse = isAr && licensureAr?.length ? licensureAr : licensure;
  const clinicalSkillsToUse =
    isAr && clinicalSkillsAr ? clinicalSkillsAr : clinicalSkills;
          ...
          {parts.map((part, i) => {
            ...
            return part ? (
              <span
                key={i}
                style={{
                  paddingLeft: part.trim().startsWith("-") ? "0" : "1rem",
                ...
                {settingsData?.linkedin && (
                  ...
                  >
                    ...
                    <span>
                      ...
                      >
                        {settingsData.linkedin.replace(/^https?:\/\//, "")}
                      </a>
                    </span>
                  </div>
                )}
          ...
          >
                    ...
                    {licensureToUse.map((item, idx) => {
                      ...
                      return (
                        <li key={idx} className="licensure-item">
                          <div
                            className="licensure-icon-wrapper"
                            style={{ marginTop: details ? "0.2rem" : "0" }}
                          >
                            <svg
                              width="20"
                              height="20"
              ...
              <section style={{ marginTop: "2rem" }}>
                ...
                <div className="timeline-container">
                  {experiences.map((exp, idx) => {
                    ...
                    const periodToUse =
                      isAr && exp.periodAr ? exp.periodAr : exp.period;
                    const clinicToUse =
                      isAr && exp.clinicAr ? exp.clinicAr : exp.clinic;
                    const respsToUse =
                      isAr && exp.responsibilitiesAr
                        ? exp.responsibilitiesAr
              ...
              <section>
                ...
                >
                  {education.map((edu, idx) => {
                    const degreeToUse =
                      isAr && edu.degreeAr ? edu.degreeAr : edu.degree;
                    const instToUse =
                      isAr && edu.institutionAr
                        ? edu.institutionAr
                        : edu.institution;
                    const yearToUse =
                      isAr && edu.yearAr ? edu.yearAr : edu.year;
                    return (
                          ...
                          >
                            ...
                            <span
                              ...
                              style={{
                                ...
                                fontWeight: "700",
                                whiteSpace: "nowrap",
                                backgroundColor: "rgba(192, 154, 107, 0.1)",
            ...
            {referencesToUse && (
              <section>
                ...
                <p style={{ color: "var(--text-dark)", fontStyle: "italic" }}>
                  {referencesToUse}
                </p>
              </section>
            )}
