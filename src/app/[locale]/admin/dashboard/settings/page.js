    ...
    <div className={styles.adminContent}>
      <div className={styles.dashboardHeader}>
        <div>
          ...
          <p style={{ color: "var(--text-muted)" }}>
            Manage site-wide contact info, social links, and security.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className={styles.formSection}>
          ...
          >
            These details will appear publicly in your website footer and
            contact sections.
          </p>
          ...
          <form onSubmit={handleSaveContact}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
              ...
              {contactMsg && (
                <span
                  style={{
                    color: contactMsg.includes("Error") ? "#EF4444" : "#10B981",
                    fontSize: "0.9rem",
                    fontWeight: 500,
                  }}
                >
        ...
        >
          <div className={styles.formSectionTitle} style={{ color: "#DC2626" }}>
            Account Security
          </div>
          <p
            style={{
          ...
          >
            Update your administrator login password. For security reasons, you
            may need to log out and log back in if your session is old.
          </p>
            ...
            {passwordMsg.text && (
              <div
                style={{
                  ...
                  color: passwordMsg.type === "error" ? "#B91C1C" : "#065F46",
                  fontSize: "0.9rem",
                }}
              >
                {passwordMsg.text}
