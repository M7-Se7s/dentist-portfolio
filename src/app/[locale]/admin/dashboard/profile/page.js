...
I believe that successful dentistry is achieved through accurate diagnosis, evidence-based treatment planning, and delivering high-quality patient-centered care with the highest standards of infection control and professionalism.`;
  ...
  const defaultQuote =
    "Every case presented in this portfolio reflects my commitment to conservative treatment principles, functional rehabilitation, esthetic excellence, and continuous professional development.";
  ...
  const handleAutoTranslate = async () => {
    if (
      !confirm(
        "This will auto-translate English fields into Arabic. Existing Arabic text may be overwritten. Continue?",
      )
    )
      return;
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      await triggerRevalidation(["/[locale]/profile", "/[locale]"], "page");
      ...
      <div className={localStyles.formCard}>
        <form onSubmit={handleSave}>
          <div className={localStyles.imageUploadLayout}>
            ...
            <div className={localStyles.imageUploadColumn}>
              ...
              <p className={localStyles.hint}>
                This is the first impression photo displayed in the main hero
              ...
              <div className={localStyles.uploadZone}>
                {homeImagePreview ? (
                  ...
                  <>
                    <svg
                      className={localStyles.uploadIcon}
                      width="32"
                      height="32"
                      fill="none"
                      stroke="currentColor"
                    ...
                    <span className={localStyles.uploadText}>
                      Click to browse
                      <br />
                      or drag image here
                    </span>
            ...
            <div className={localStyles.imageUploadColumn}>
              ...
              <p className={localStyles.hint}>
                This photo is shown next to your clinical biography on the
                Profile page.
              </p>
          ...
          <div style={{ display: "flex", gap: "2rem", marginBottom: "1.5rem" }}>
            ...
            >
              <label htmlFor="biography" className={localStyles.label}>
                Biography (EN)
              </label>
              <textarea
                id="biography"
            ...
            <div
              ...
              style={{ flex: 1, marginBottom: 0 }}
            >
              <label htmlFor="biographyAr" className={localStyles.label}>
                Biography (AR)
              </label>
              <textarea
                id="biographyAr"
          ...
          <small
            className={localStyles.hint}
            style={{ display: "block", marginBottom: "2rem" }}
          >
            Line breaks will be preserved as separate paragraphs on the profile
            page.
          </small>
          ...
          <div style={{ display: "flex", gap: "2rem" }}>
            ...
            <div className={localStyles.formGroup} style={{ flex: 1 }}>
              <label htmlFor="quoteAr" className={localStyles.label}>
                Philosophy Quote (AR)
              </label>
              <textarea
                id="quoteAr"
