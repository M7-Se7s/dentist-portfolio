      ...
      <div className="container">
        <div className={styles.footerContent}>
          <div className={styles.footerRow}>
            <span className={styles.footerName}>Dr. Mohamed Shaaban</span>
            <span className={styles.footerTitle}>General Dentist</span>
            <div className={styles.footerIcons}>
              ...
              <a href={`tel:${phone}`} className={styles.footerIconLink} aria-label="Phone">
                ...
                <span className={styles.iconText}>Phone</span>
              </a>
            </div>
          </div>
          <div className={styles.footerCopyright}>
            <div>&copy; {new Date().getFullYear()} Dr. Mohamed Shaaban. All rights reserved.</div>
            <div className={styles.developerCredit}>Developed by M7-Se7s</div>
          </div>
        </div>
      </div>
    </footer>
